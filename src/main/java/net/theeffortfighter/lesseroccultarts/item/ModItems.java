...
public class ModItems {
    ...
    public static final Item GOTD = registerItem("greatsword_of_the_damned", new SwordItem(ModToolMaterials.LOA,11,1, new FabricItemSettings().group(ModItemGroup.LESSER_OCCULT_ARTS)));
