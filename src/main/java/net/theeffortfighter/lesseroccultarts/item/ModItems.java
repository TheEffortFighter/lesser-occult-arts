...
public class ModItems {
    ...
    public static final Item CROWN = registerItem("monarch_crown", new Item(new FabricItemSettings().maxCount(1).group(ModItemGroup.LESSER_OCCULT_ARTS)));
    public static final Item MACE = registerItem("malice_mace", new Item(new FabricItemSettings().maxCount(1).group(ModItemGroup.LESSER_OCCULT_ARTS)));
    public static final Item SEAL = registerItem("monarch_seal", new Item(new FabricItemSettings().maxCount(1).group(ModItemGroup.LESSER_OCCULT_ARTS)));
