...
public class ModItems {
    ...
    public static final Item EFFIGY = registerItem("abyssal_effigy", new AbbyssalEffigy(new FabricItemSettings().maxCount(1).group(ModItemGroup.LESSER_OCCULT_ARTS)));
